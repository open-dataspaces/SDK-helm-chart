...
# 全てのモデルをインポート（Alembicがテーブルを検出するため）
...
# Note: notifications_model.py is not yet implemented
...
def get_url() -> str:
    """
    データベースURLを取得
    環境変数DATABASE_URLがあればそれを使用、なければsettingsから取得
    """
    import os
...
def run_migrations_online() -> None:
    ...
    """
    # alembic.iniの設定を取得し、DATABASE_URLを上書き
